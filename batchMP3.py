...
print("-------------------------------------------------------------")
wav_files = glob.glob('/Users/YJC/Desktop/Uniandes/Maestria/AplicacionesCloud/Proyectos/Proyecto_1_Total/SuperVoiceProject/media/*.wav')
for wav_file in wav_files:
	...
	shutil.move(wav_file, '/Users/YJC/Desktop/Uniandes/Maestria/AplicacionesCloud/Proyectos/Proyecto_1_Total/SuperVoiceProject/media/procesados/')
print("-------------------------------------------------------------")
print("Convirtiendo archivos OGG a MP3")
print("-------------------------------------------------------------")
ogg_files = glob.glob('/Users/YJC/Desktop/Uniandes/Maestria/AplicacionesCloud/Proyectos/Proyecto_1_Total/SuperVoiceProject/media/*.ogg')
for ogg_file in ogg_files:
	...
	shutil.move(ogg_file, '/Users/YJC/Desktop/Uniandes/Maestria/AplicacionesCloud/Proyectos/Proyecto_1_Total/SuperVoiceProject/media/procesados/')
...
print("-------------------------------------------------------------")
path_procesados = '/Users/YJC/Desktop/Uniandes/Maestria/AplicacionesCloud/Proyectos/Proyecto_1_Total/SuperVoiceProject/media/procesados/'
lstFilesConvertir = []
...
path_generados = '/Users/YJC/Desktop/Uniandes/Maestria/AplicacionesCloud/Proyectos/Proyecto_1_Total/SuperVoiceProject/media/'
lstFilesMP3 = []
